 ...
 */
export const TextLayout : React.FC<ITextLayout> = ({
  children = null,
  variant = "",
  ...props
}) => {
  return (<div className={`if text layout ${variant}`} {...props}>{children}</div>);
}

// TextBox
export interface ITextLayoutBox {
    children?: any, 
    variant?: 'left' | 'right' | "large" | "",
    [x: string]: any
}
 ...
 */
export const TextLayoutBox : React.FC<ITextLayoutBox> = ({
    children = null,
    variant = "",
    ...props
}) => {
    return (<div className={`if text layout box${variant ? " " + variant : ""}`} {...props}>{children}</div>);
}
 ...
 */
export const TextBody : React.FC<ITextBody> = ({
    children = null,
    ...props
}) => {
    return (<div className={`if text body`} {...props}>{children}</div>);
}
